...
<form method="post" action="{{ route('pegawai.update', $pegawai->id) }}" enctype="multipart/form-data">
   ...
   <div class="row mt-3">
      ...
      <div class="col-sm-4">
		   <input  type="text" id="nama" name="nama" value="{{ $pegawai->nama_pegawai }}"
   ...
   <div class="row mt-3">
      ...
      <div class="col-sm-2">   
        <input type="text" id="tanggal" name="tgl_lahir" 
            value="{{ date('m/d/Y', strtotime($pegawai->tgl_lahir)) }}"
